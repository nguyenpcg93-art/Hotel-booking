...
const Hero = () => {
    ...
    const onSearch = async (e)=>{
        ...
        //call api to save recent city searched
  ...
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
      <p className='bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20'>Welcome to our hotel</p>
      <h1 className='font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extra-bold max-w-xl mt-4'>Experience Luxury Like Never Before</h1>
      <p className='max-w-130 mt-2 text-sm md:text-base'>Discover the epitome of comfort and elegance at our hotel. Book your stay today and indulge in a world of unparalleled luxury.</p>
