        ...
        {bookings.map((booking)=>(
            <div key={booking._id} className='grid grid-col-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                ...
                <div className='flex flex-col items-start justify-center pt-3'>
                    ...
                    {!booking.isPaid && (
                        <button onClick={()=>handlePayment(booking._id)} className='px-4 py-1.5 mt-4 text-xs border boder-gray-500 rounded-full hover:bg-gray-300 transition-all cursor-pointer'>
                            Pay Now
                        </button>
                    )}
